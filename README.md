...
<img src="assets/preview.png" alt="LiteLLM privacy mode in the native Agents panel" width="420">
...
Set `privacyMode` to `true` to opt into replacing model IDs with `Model 1`, `Model 2`, …
